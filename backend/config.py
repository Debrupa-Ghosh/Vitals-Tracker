...
class Config:
    ...
    DB_USER = os.environ.get("VT_DB_USER", "root")
    DB_PASSWORD = os.environ.get("VT_DB_PASSWORD", "Debrupa@2005")
    DB_NAME = os.environ.get("VT_DB_NAME", "vitals_tracker")
    GEMINI_API_KEY = os.environ.get("GEMINI_API_KEY", "AIzaSyAVQxasbZdcbRGFzWS7yuNNdMpiUFUp_JI")

    # Flask
    DEBUG = os.environ.get("VT_DEBUG", "true").lower() == "true"
    HOST = os.environ.get("VT_HOST", "0.0.0.0")
    PORT = int(os.environ.get("VT_PORT", 5000))
